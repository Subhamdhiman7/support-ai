...
function DashboardClient({ownerId}:{ownerId:string}) {
  ...
  return (
    <div className='min-h-screen bg-zinc-50 text-zinc-900'>  
            ...
            >
                <div className='max-w-7xl mx-auto px-6 h-16 flex items-center justify-between'>
                    ...
                    <button className='px-4 py-2 rounded-lg border border-zinc-300 
                    text-sm hover:bg-zinc-100 transition' onClick={()=>navigate.push("/embed")}>Embed ChatBot</button>
                </div>
            </motion.div>
    ...
    <div className='mb-10'>
        ...
        <p className='text-zinc-500 mt-1'>Manage your AI chatbot knowledge and business details
        </p>
    </div>
    ...
    {/* <div className='mb-10'>
        ...
        <div className='space-y-4'>
            <input type="text" 
                    ...
                    border-zinc-300 px-4 py-3 text-sm focus:outline-none 
            ...
            <input type="text" className='w-full rounded-xl border border-zinc-300
                    ...
                    focus:ring-2 focus:ring-black/80' 
                    placeholder='Support Email' value={supportEmail} onChange={(e)=>setSupportEmail(e.target.value)}/></div>
    ...
    <div className='mb-10'>
        <h1 className='text-lg font-medium mb-4'>Knowledge Based</h1>
        <p className='text-sm text-zinc-500 mb-4'>Add FAQs, policies, delivery info, refunds etc.</p>
        <div className='space-y-4'>
            <textarea className='w-full h-50 rounded-xl border 
                    border-zinc-300 px-4 py-3 text-sm focus:outline-none 
                    focus:ring-2 focus:ring-black/80' 
                    placeholder={`Example:
                ...
                • Support hours`} onChange={(e)=>setknowledge(e.target.value)} value={knowledge}/></div>
