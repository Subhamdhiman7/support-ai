...
//                         <button className='absolute-top-3 right-3 bg-white text-zinc-900 text-xs font-medium px-3 py-1.5 rounded-lg hover:bg-zinc-200 transition'>
//                             {copied?"Copied ✓":"Copy"}
//                         </button>
//                     </div>
        ...
        <div className="min-h-screen bg-zinc-50 text-zinc-900">
            ...
            <div className='flex justify-center px-4 py-14'>
                <motion.div
                    ...
                    <div className='relative bg-zinc-950 text-zinc-100 rounded-2xl p-6 text-sm font-mono overflow-hidden'>
                        <pre className='overflow-x-auto whitespace-pre-wrap break-all'>
                            {embedCode}
                        </pre>
                        <button
                            
                            className='absolute top-4 right-4 bg-white text-zinc-900 text-xs font-medium px-4 py-2 
                            rounded-lg hover:bg-zinc-200 transition' onClick={copyCode}>
                            {copied ? "Copied ✓" : "Copy"}
                        </button>
                    </div>
                    ...
                    <div className='mt-14'>
                        ...
                        <p className='text-sm text-zinc-500 mb-6'>
                            This is how the chatbot will appear on your website</p>
                        ...
                        <div className='rounded-xl border border-zinc-300 bg-white shadow-md overflow-hidden'>
                            ...
                            <div className='relative h-64 sm:h-72 p-6 text-zinc-400 text-sm'>
                                ...
                                shadow-xl border border-zinc-200 overflow-hidden'>
                                    <div className='flex items-center justify-between px-2 py-2 bg-black text-white text-sm'>
